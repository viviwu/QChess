//
//  UserConsultInfoTableController.m
//  Touhu
//
...
@interface UserConsultInfoTableController ()
...
@implementation UserConsultInfoTableController
...
- (IBAction)cateChanged:(UISegmentedControl*)sender {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section==0) {
        ...
        UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ask" forIndexPath:indexPath];
